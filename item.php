...
<html>
  ...
  <body style='background: #090909'data-home-page="item.php" data-home-page-title="Proyectos" class="u-body u-overlap u-white u-xl-mode" data-lang="es">
  <?php 
    require ('conexion.php');

    $iditem=$_GET['id'];
    $SELECT=mysqli_query($conexion, "SELECT * FROM items WHERE iditem=$iditem");
    while($r=mysqli_fetch_array($SELECT)){

        $nombre_item=$r['nombre_item'];
        $precio=$r['precio'];
        $imagen_item=$r['imagen_item'];
        $rareza_item=$r['rareza_item'];
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="tiendalist.php">Tienda</a></li>
              ...
              <div class="u-layout-row">
                <div class="u-container-style u-layout-cell u-left-cell u-size-60 u-layout-cell-1" src="">
                  <div class="u-container-layout u-container-layout-1">
                    <img class="u-image u-image-1" src="./img/items/<?php echo $imagen_item;?>" alt="..." data-image-width="1080" data-image-height="1080">
                  </div>
                </div>
              </div>
            </div>
            <div class="u-size-30">
              <div class="u-layout-col">
                <div class="u-container-style u-hidden-sm u-hidden-xs u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                  ...
                  <h2 class="u-text u-text-3" align= 'center'><?php echo $nombre_item;?></h2>
                ...
                <div style='background: #090909' class="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-white u-layout-cell-3">
                  <div class="u-container-layout u-container-layout-3">
                    <h4 class="u-text u-text-2"align= 'left'>ESTADO:   <?php echo $estado_item; ?></h4>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section  style='background: #090909' class="u-align-center u-clearfix u-white u-section-2" id="sec-446b">
      <div  class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="comment-form-container">
            <div class="container"> <h4><?php echo $nombre_item;  echo ' le recuerda ser respestuoso con los otros usuarios' ?></h4></div>
