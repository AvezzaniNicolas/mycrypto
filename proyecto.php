...
<html>
  ...
  <?php 
            ...
            <div class="u-size-30">
              <div class="u-layout-col">
                <div class="u-container-style u-hidden-sm u-hidden-xs u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                  ...
                  <h2 class="u-text u-text-3 text-left"><?php echo $nombre_proyecto; ?></h2>
    ...
    <div style="text-align: center; margin-top: 20px; color: white;"> Whitepaper: <?php echo $whitepaper_proyecto; ?></div>
...
<div class="fb-comments" data-href="https://yourwebsite.com/proyecto.php?id=<?php echo $idproyecto; ?>" data-width="" data-numposts="5"></div>
<br> <br> <br>
