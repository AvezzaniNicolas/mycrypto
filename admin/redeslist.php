  ...
  <body style="background: #212529;" >
    ...
    <div class="container">
	  ...
	  <div class="breadcrumb-container">
		 <ol class="breadcrumb">
		 	<li><a href="../inicio.php" class="btn btn-warning" role="button">Volver al menu de inicio</a></li>
		  	<li><a href="proyectoslist.php"class="btn btn-warning" role="button">ir a juegos</a></li>
		  	<li><a href="../perfil.php"class="btn btn-warning" role="button">ir a mi perfil</a></li>
				...
				/* herramienta para depurar el id rol
