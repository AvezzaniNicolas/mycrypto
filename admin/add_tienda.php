    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar Tienda</h3>
			<form action="abm_tienda.php" class="form-horizontal"  method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="nombre_tienda"  required name="nombre_tienda">
			  ...
			  <div class='outer_div'></div>
				<div class="col-sm-offset-3 col-sm-9">
				  <button id="insert" name="insert" value="insert" type="submit" class="btn btn-success">Agregar Tienda</button>
				</div>
			  </div>
